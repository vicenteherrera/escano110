...
class email_cambio_estado extends email {
    ...
    function get_message_enviada() {
        $result = 'Hemos recibido tu iniciativa/pregunta/propuesta en Escaño110. ';
    ...
    function get_message_rechazada() {
        ...
        $result .= 'publicada en la web con esa formulación. En breve recibirás un email nuestro en el que'; 
    ...
    function get_message_cerrada() {
        $result = 'El plazo de admisión de '.$this->avotable_data->get_nombre_apoyos().' para tu '.$this->avotable_data->get_nombre_tipo().' en ';
        $result .= 'Escaño110 se ha cerrado: '.$this->get_url().'<br /><br />';
        $result .= 'Te damos la enhorabuena por los logros obtenidos y te animamos a seguir participando';
        $result .= 'con nuevas iniciativas en esta plataforma, porque #somosel110.';
        return $result;
    }
}
